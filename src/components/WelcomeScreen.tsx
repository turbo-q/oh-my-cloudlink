...
export function WelcomeScreen({ panel, selectedHost, onConnect, onAddHost }: WelcomeScreenProps) {
    ...
    <div className="flex-1 flex items-center justify-center bg-[#0f1117] pt-4">
      <div className="text-center max-w-md px-6">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">
          {isSftp ? 'SFTP 文件传输' : '欢迎使用云连 SSH'}
        </h2>
        <p className="text-slate-400 mb-8 leading-relaxed">
          {isSftp
            ? '在左侧选择已配置的主机，即可直接打开 SFTP 文件浏览器，无需单独添加传输配置。'
            : '在左侧添加并管理你的服务器，双击主机即可快速 SSH 连接。支持密码和密钥认证。'}
        </p>
